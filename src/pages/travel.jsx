...
const TravelGallery = () => {
  ...
  const images = [
    ...
    { url: "src/assets/travel/p13.jpg", alt: "Placeholder 12", size: "row-span-2" },
    { url: "src/assets/travel/p14.jpg", alt: "Placeholder 13", size: "" },
    { url: "src/assets/travel/p15.jpg", alt: "Placeholder 14", size: "" },
    { url: "src/assets/travel/p16.jpg", alt: "Placeholder 15", size: "col-span-2" },
    { url: "src/assets/travel/p17.jpg", alt: "Placeholder 16", size: "" },
    { url: "src/assets/travel/p18.jpg", alt: "Placeholder 17", size: "" },
    { url: "src/assets/travel/p19.jpg", alt: "Placeholder 18", size: "row-span-2" },
    { url: "src/assets/travel/p20.jpg", alt: "Placeholder 19", size: "" },
    { url: "src/assets/travel/p21.jpg", alt: "Placeholder 20", size: "col-span-2" },
    { url: "src/assets/travel/p22.jpg", alt: "Placeholder 21", size: "" },
    { url: "src/assets/travel/p23.jpg", alt: "Placeholder 22", size: "" },
    { url: "src/assets/travel/p24.jpg", alt: "Placeholder 23", size: "" },
    { url: "src/assets/travel/p25.jpg", alt: "Placeholder 24", size: "col-span-2" },
    { url: "src/assets/travel/p26.jpg", alt: "Placeholder 25", size: "" },
    { url: "src/assets/travel/p27.jpg", alt: "Placeholder 26", size: "" },
    { url: "src/assets/travel/p28.jpg", alt: "Placeholder 27", size: "col-span-2" },
  ];
